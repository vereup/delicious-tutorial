            ...
            <div class="p-2 docs-highlight">
                ...
                <ul class="nav nav-pills mb-2 border-bottom" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link @if ($tab === 'review' || !request()->tab) active @endif" id="myReview-tab"
                            data-coreui-toggle="pill" data-coreui-target="#myReview" type="button" role="tab" aria-controls="pills-home" 
                            aria-selected="true" style="width:220px;height:75px;" href="/mypage/?tab=review">내 리뷰 </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link @if($tab === 'wish') active @endif" id="wishList-tab" 
                        data-coreui-toggle="pill" data-coreui-target="#wishList" type="button" role="tab" aria-controls="pills-profile" 
                        aria-selected="false" style="width:220px;height:75px;" href="/mypage?tab=wish">찜 목록</button>
                    </li>
                </ul>
