                ...
                <div class="container p-2">
                    <div class="d-flex flex-column" style="background-color: white">
                        <div class="p-2 docs-highlight">
                            {{-- 로그인된 사용자에 따라 변경 --}}
                                    <p class="fs-2 fw-bold p-4">{{$loginUser->name}} &#40;{{$loginUser->email}}&#41;</p>
                        </div>
                        <div class="p-2 docs-highlight">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div
                                    ...
                                    @foreach ($userReviews as $userReview)
                                        @if($userReview->user_id == $loginUser->id) 
                                ...
                                <div
                                    ...
                                    <div class="row">
                                        <h2 class="fs-5 fw-bold ps-4 pt-4 pb-2">찜 목록 &#40;
                                            @php
                                                $wishesCount = count($userWishes);
                                                echo $wishesCount;
                                            @endphp
                                            &#41;</h2>
                                    </div>
                        @foreach ($userWishes as $userWish)
                            @if($userWish->user_id == $loginUser->id) 
                            @php
